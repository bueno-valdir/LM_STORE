      ...
      <div class="grid gap-8 md:grid-cols-2">
        ...
        <section>
          ...
          <div class="mt-3 flex flex-wrap gap-2">
            ${d?'<span class="etiqueta bg-marca text-white">Promocao</span>':""}
          ...
          <div class="mt-6">
            ...
            <p class="mt-2 text-xs text-texto-suave">Voce sera levada ao WhatsApp com a mensagem do produto ja preenchida.</p>
          </div>
        </section>
